...
export default function Page() {
  ...
  const blsDaily = blsWage && billableDays > 0 ? blsWage / billableDays : null;  return (
      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-slate-200 p-10 relative overflow-hidden">
        ...
        <div className="mb-8 relative z-10">
          <div className="flex flex-wrap gap-4 mb-4">
            <div>              <label className="block text-slate-700 font-semibold mb-1">Major Group</label>
              <select className="border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" value={selectedMajor} onChange={e => setSelectedMajor(e.target.value)}>
                {majorGroups.map(mg => <option key={mg.code} value={mg.code}>{mg.name}</option>)}
              </select>
            </div>
            
            <div>              <label className="block text-slate-700 font-semibold mb-1">Search Detailed Occupation</label>
              <input
                type="text"
                placeholder="Type to search all detailed occupations..."
                className="border border-slate-300 rounded-lg px-3 py-2 mb-2 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                value={detailedOccupationSearch}
                onChange={e => setDetailedOccupationSearch(e.target.value)}
              />
              <label className="block text-slate-700 font-semibold mb-1">Detailed Occupation</label>
              <select
                className="border border-slate-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"// Added w-full for better layout
              ...
              <label className="block text-slate-700 font-semibold mb-1">U.S. State</label>
              <select className="border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" value={selectedRegion} onChange={e => setSelectedRegion(e.target.value)}>
